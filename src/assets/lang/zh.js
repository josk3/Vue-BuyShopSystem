module.exports = {
    ...
    "nav": {
        ...
        "can_view_paid_report": "成功交易卡片",
        "can_view_refund_report": "退款卡片",
        "can_view_decline_report": "拒付卡片",
        "can_view_top10_site_report": "商户top10网站卡片",
    },
    "user": { //跟用户相关
        "name": "姓名或公司名",
        "username": "用户名",
    ...
    "account": {
        ...
        "notice_setup": "通知设置",
        "service_email_settings": "客服邮箱设置",
        "service_email_settings_tip": "此客服邮箱是用于客服日常接收成功订单给持卡人发邮件的邮箱。",
        "update_email": "修改邮箱",
        "enter_email": "请输入邮箱",
    ...
    "settle": {
        ...
        "settle_sign": "结算签署",
        "settle_sign_ok": "完成结算签署",
        "settle_sign_file": "结算签署文件",
    },
    "order": {
    ...
    "report": {
      ...
      "successful_payment_remark": "在特定范围内成功处理的订单总额,指收款",
      "dishonor_rate": "拒付率",
      "dishonor_rate_remark": "指在特定范围内导致订单失败的拒付比例",
      "refund": "退款",
      "refund_remark": "指在特定范围内成功退款的订单总额",
      "trading_volume": "交易量",
      "trading_total": "交易额",
      "refund_amount": "退款金额",
      "proportion_of_trading_countries": "交易国家占比详情",
      "top_10_sites_by_volume": "交易量前十的网站",
      "ranking_of_the_last_30_days": "最近30天内成功交易的排名",
      "country": "国家",
      ...
      "total_refund": "退款笔数",
      "my_cards":"我的卡片",
      "please_select_cards": "请选择卡片",
      "select_cards_to_display": "请选择要展示的卡片",
    },
    "shop": {
        "site_url": "网址",
        "return_url": "返回网址",
