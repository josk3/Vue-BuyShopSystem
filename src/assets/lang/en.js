module.exports = {
	...
	"comm": { //通用
		...
		"category": "category",
		"download_Authorization_explain": ["Download the template form",
			"and fill in the corresponding 'Notice of Entrustment for Collection of Business Funds'."
		],
	...
	"login": {
		...
		"resolver_email_send": ["Reset email sent",
			"Sending successfully, you can now enter the mailbox to reset your password"
		],
	...
	"account": {
		...
		"notice_setup_info": ["If you want to close the notification, please contact customer service", "Or",
			"Support ticket"
		],
