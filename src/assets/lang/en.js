module.exports = {
    ...
    "nav": {
        ...
        "paid_report": "Paid Card",
        "refund_report": "Refund Card",
        "decline_report": "Declined Card",
        "top10_site_report": "Merchant Top10 WebSite Card",
    ...
    "user": { //跟用户相关
        ...
        "upload_identity_photo_a2": "Upload the front view of ID card photo",
        "identity_photo_a_company_tip": "Please upload the latest ID card front view photo of legal representative",
        "identity_photo_a_person_tip": "Please upload the latest front view of ID card photo",
        "identity_photo_a_outland_tip": "Please upload the latest front view of ID card photo",
        "please_follow": "According to",
        "sample_template":"the sample template",
        "identity_photo_b": "The back view of ID card",
        "upload_identity_photo_b": "Upload the back view of ID card photo",
        "identity_photo_b2": "The back view of ID card",
        "upload_identity_photo_b2": "Upload the back view of ID card photo",
        "identity_photo_b_company_tip": "Please upload the latest ID card back view photo of legal representative",
        "identity_photo_b_person_tip": "Please upload the latest back view of ID card photo",
        "identity_photo_b_outland_tip": "Please upload the latest back view of ID card photo",
        "identity_photo_c": "The photo of holding an ID card",
        "upload_identity_photo_c": "Upload the photo of holding an ID card",
        "identity_photo_c2": "The photo of holding an ID card",
        "upload_identity_photo_c2": "Upload the photo of holding an ID card",
        "identity_photo_c_tip": "Please upload the latest color photo of  holding an ID card",
        "identity_photo_c_outland_tip": "Please upload the latest color photo of holding an ID card",
        "identity_bank_photo": "Bank photo",
        "identity_number": "ID number",
        "identity_number2": "ID card number",
        "identity_start_date": "ID valid period",
        "identity_start_date2": "Start time of certificate validity",
        "identity_expire_date": "ID valid period",
        "identity_expire_date2": "Expiration time of certificate validity",
        "qq": "QQ",
        "address": "Address",
        "personal_address": "Business address",
        "zip_code": "Zip code",
        "shop_site": "Shop site url",
        "company_identity_photo": "Business license",
        "upload_company_identity_photo": "Upload the business license",
        "company_identity_id": "Company ID",
        "company_start_date": "Company ID valid period",
        "company_expire_date": "Company ID valid period",
        "upload_company_identity_photo_tip": "Please upload a color photo of the latest business license",
        "company_scope": "Company scope",
        "company_phone": "Company phone",
        "company_register_address": "Place of business registration",
        ...
        "belong_what_country": "Country",
        "personal_identity": "Personal identification",
        "personal_identity_tip": "the number of ID card or passport",
        "company_register_country": "Place of business registration",
        "is_own_subsidiary": "Is there a subsidiary company?",
        "subsidiary_name": "The name of the subsidiary company",
        "subsidiary_country": "The registered place of the subsidiary company",
        "out_company_start_date": "Start time of business registration certificate",
        "out_company_expire_date": "Expiration time of business registration certificate",
        "company_business_identity_photo": "Business registration certificate",
        "upload_company_business_identity_photo": "Upload business registration certificate",
        "company_business_identity_photo_tip": "Please upload a color photo of the latest business registration certificate",
        "company_register_identity_photo": "Company registration certificate",
        "upload_company_register_identity_photo": "Upload company registration certificate",
        "company_register_identity_photo_tip": "Please upload a color photo of the latest registration certificate",
        "company_annual_report_photo": "Incorporation form",
        "upload_company_annual_report_photo": "Upload the incorporation form",
        "company_annual_report_photo_tip": "Please upload a color photo of the latest Incorporation Form",
        "company_position":"Personal identity confirmation",
        "chairman": "Corporate Directors",
        "shareholder": "Shareholders holding more than 25% of the shares",
        "none": "None of the above",
        "identity_id": "The ID card",
        "passport": "The passport",
        "hk_pass": "Valid Exit-Entry Permit (EEP) to HK / Macau",
        "chairman_authorization": "Director's Power of Attorney",
        "upload_chairman_authorization": "Upload the director's Power of Attorney",
        "chairman_authorization_tip": "Please upload the scanned copy of the latest Director's Power of Attorney",
    ...
    "account": {
        ...
        "service_email_settings": "Customer service email settings",
        "service_email_settings_tip": "Please advise your customer service email to ensure that the cardholder can contact with you when they have problems with the order.",        
    ...
    "report": {
        ...
        "successful_payment": "Successfully paid",
        "successful_payment_remark": "The amount of paid order in the specific period (It refers to the collection)",
        "dishonor_rate": "The chargeback ratio",
        "dishonor_rate_remark": "The chargeback ratio in the specific period",
        "refund": "Refund",
        "refund_remark": "The amount of refund order in the specific period",
        "trading_volume": "Trading Volume",
        "trading_total": "Turnover",
        "refund_amount": "Refund Amount",
        "proportion_of_trading_countries": "Details of the proportion of trading countries",
        "top_10_sites_by_volume": "Top 10 websites with transaction volume",
        "ranking_of_the_last_30_days": "Ranking of successful transactions number in the latest 30 days",
        "country": "Country",
        ...
        "my_cards":"My cards",
        "please_select_cards": "Please select cards",
        "select_cards_to_display": "Please select the cards to be displayed",
    },
    "shop": {
        "site_url": "Shop url",
    ...
    "bank": {
        ...
        "name_tip2": "Account name of beneficiary",
        "bank_name": "Account with bank",
        "bank_name2": "Name of account with bank",
        "bank_name_tip": "The bank name that handles account opening procedures",
        "bank_name_tip2": "Name of the bank that opened the account",
        "bank_country":"The location of the bank",
        "bank_country2":"The location of the bank",
        "bank_country_tip":"Country and state",
        "bank_country_tip2":"Province and city",
        "bank_address": "Bank address",
        "bank_address2": "Bank address",
        "bank_address_tip": "The address of the bank ",
        "bank_address_tip2": "Detailed address of the bank",
        "bank_branch": "Sub-branch of Account with bank",
        "bank_branch_tip": "For example: Industrial and Commercial Bank of China ***Sub-branch",
        ...
        "authorize_photo": "Letter of authorization",
        "card_id_error_message": "Please fill in the correct ID number",
        "inland_bank_account": "Domestic bank accounts",
        ...
        "authorization_relation_tip": "Relationship between the beneficiary and you",
        "card_company_register_address_tip": "Refers to the address of the business license",
        ...
        "upload_Authorization_explain": "The Notice of Entrustment for Collection of Business Funds shall be in the form of scanned copy",
        "upload_authorize_success_tip": "Please send the original 'Notice of Entrustment for Collection of Business Funds' back to our company (please contact our customer service for detailed receiving address). We will review the information of the beneficiary account, and the settlement application can be submitted after approval.",
    },
