			...
			<div class="row">
				...
				<div class="col-8">
					...
					<el-form ref="detail" :model="detail" :disabled="hold_edit" :rules="rules"
						...
						<div class="company-outland"
							...
							<el-form-item :label="$t('user.out_company_start_date')" prop="out_company_start_date">
								<el-date-picker v-model="detail.out_company_start_date" value-format="yyyy-MM-dd"
									type="date" :placeholder="$t('comm.select') + $t('user.out_company_start_date')">
								</el-date-picker>
							</el-form-item>
							<el-form-item :label="$t('user.out_company_expire_date')" prop="out_company_expire_date">
								<el-date-picker v-model="detail.out_company_expire_date" value-format="yyyy-MM-dd"
									type="date" :placeholder="$t('comm.select') + $t('user.out_company_expire_date')">
								</el-date-picker>
							...
							<el-form-item :label="$t('user.company_annual_report_photo')"
								...
								<UploadImgOnce :txt="$t('user.upload_company_annual_report_photo')" size="sm"
									:disable="hold_edit" :img_url="fullImgUrl(detail.company_annual_report_photo_url)"
						...
						<div class="personal">
							...
							<el-form-item
								...
								<UploadImgOnce
									...
									size="sm" :disable="hold_edit" :img_url="fullImgUrl(detail.identity_photo_a_url)"
							...
							<el-form-item
								...
								<UploadImgOnce
									...
									size="sm" :disable="hold_edit" :img_url="fullImgUrl(detail.identity_photo_b_url)"
							...
							<el-form-item
								...
								<UploadImgOnce
									...
									size="sm" :disable="hold_edit" :img_url="fullImgUrl(detail.identity_photo_c_url)"
						...
						<el-form-item v-show="detail.identity_account_type === 'personal'" :label="$t('user.address')"
							prop="address">
