  ...
  <div v-loading="loading">
    <div class="row p-0">
      ...
      <el-alert
          ...
          :description="$t('account.expire_time') + ': ' + this.info.expire_date + '  （' + this.remainingDays + $t('account.remainingDays') + ')'"
          class="mb-2">
      </el-alert>
      <el-alert
          v-if="monthTradeLimitAlert"
          type="warning"
          show-icon
          ...
          <div class="row p-0">
            <div class="col-11 row">
              <div class="col-4 item">
                <i class="el-icon-info text-blue"></i> {{ $t('home.this_month_ecm') }} {{
                  ecmRateText(user.monitor_ecm)
                }}
              </div>
              <div class="col-4 item">
